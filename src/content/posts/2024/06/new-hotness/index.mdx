...
"Oh, you should start a CSS users group!" Friend, my list of "shoulds" far outstrips my capacity for "can," and starting a local developer user group isn't even in the first screenful. 
