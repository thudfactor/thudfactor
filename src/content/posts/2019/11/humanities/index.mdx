...
cover:
  ...
  description: Some application development has more in common with artistic creative work than it does engineering. Photo by [Patrick Tomasso](https://unsplash.com/@impatrickt?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/photos/Oaqk7qqNh_c).
  attribution:
