...
{% articleFig "pinupPose.jpg" "A woman laying on her stomach, wearing a polka-dot dress, smiling. There is a Coca-cola branded cooler and a Coke bottle nearby." "right" %}
...
If Automatic1111 looks like a jet cockpit, ComfyUI resembles nothing so much as a modular synth. [Sythesizers make things too easy, remember](https://www.sweetwater.com/insync/re-creating-the-classic-minimoog-synthesizer-with-eurorack-modules/). You add blocks which represent parts of the AI construction process -- load the model, prep the decoder, run the sampler, view the results -- and wire them all together in the order you want. Once you get the hang of it, it’s really handy. But setting up even a simple workflow is a bit of a shock, especially if you’ve been led to believe all you have to do is write a prompt.
...
{% articleFig "celtic.jpg" "A woman with messy, braided red hair and green eyes, wearing a tunic decorated with celtic knots, looking to the right with a grim expression on her face." "right" %}
...
You can [see the full-size version](/img/celtic.jpg).
