...
My current intention is to use this space to write about things I learn, primarily for my own benefit. This approach has worked well for me over at [FilmHydra](https://www.filmhydra.com), which serves as a long form film diary. Here I will talk a lot about web development, agile processes, and… well, anything else I am bouncing around in my head.
...
<AlertCallout>
	Update: since writing this, I've migrated the site to [Astro](https://astro.build/).
</AlertCallout>
