...
- [Sarah Wilkes](https://sarahwilkesdev.com/), who made the Infyo site above, started a blog a bit ago with [a recipe for beer-cheese soup](https://sarahwilkesdev.com/blog/beer-cheese-soup/)
- [Film Optimist](https://filmoptimist.blog/) C. Glen Williams’s media commentary is fun; this blog is the companion to their YouTube channel, which tends to do _extremely_ deep dives on, for example, [Captain America](https://www.youtube.com/playlist?list=PL0KNo7dSX9klzj-indE4KC8bUm__GQYMl).
