...
<figure>
<ArticleImage image={import('./suggestion.png')} alt="Clip of a suggestion from co-pilot while writing this blog post. Text in the caption." />
<figcaption>Sometimes it doesn’t have any part of the picture. Here, co-pilot tries to write the caption for this post’s cover photo. It suggests completing “the cockpit from Airplane the movie” with the caption “I am serious. And don’t call me Shirley.” That doesn’t match the image at all.</figcaption>
</figure>
...
<figure>
  <ArticleImage image={import('./suggestion-2.png')} alt="Clip of another suggestion from co-pilot while writing this blog post, text in the caption." />
  <figcaption>
