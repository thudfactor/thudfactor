...
<ArticleFigure
	variant="right"
	image={Peter}
	alt="Animated gif of Peter Griffin from Family Guy trying to adjust horizontal window blinds. The superimposed caption says CSS"
>
	Of course, if Peter would just take a moment to understand how horizontal blinds work…
</ArticleFigure>
...
## CSS is a powerful language. It’s just programming
