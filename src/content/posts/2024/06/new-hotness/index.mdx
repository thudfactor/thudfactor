---
title: Uptake of the new CSS seems slow
subtitle: and here are several reasons why
date: 2024-06-19T09:51:34 
categories:
  - CSS
tags: post
description: There’s so much great new stuff in CSS, some of it with extraordinary support. Why aren’t people leapping on it?
cover:
  src: ./fortune.png
...
<ArticleImage image={import("./poppins.jpg")} alt="Mary Poppins flying away. Text says Screw this, I am done. So done." align="right" />
...
"Oh, you should start a CSS users group!" Friend, my list of "shoulds" far outstrips my capacity for "can," and starting a local developer user group isn't even "above the fold."
...
Finally, the new stuff is going to take a while to get uptake. The Last Great Evangelism I saw in web development was [Ethan Marcotte leading us all to responsive web design](https://alistapart.com/article/responsive-web-design/). He explained the what, the how, and the why very well. That was web-developer generational effort on a par with discarding tables for layout, and also the cooperation of a lot of other people. My project manager had to persuade _me_. I had to persuade UX folks and designers. Everyone had to persuade people with purse strings. 
...
5. There's something about web developer culture at the moment that feels very insular and gate-keepery, which makes getting the word out hard.
6. Also, new web paradigms, [like love](https://youtu.be/FkDpwF6-QiA?si=abWbTT8GFXttHrba), takes time. 
