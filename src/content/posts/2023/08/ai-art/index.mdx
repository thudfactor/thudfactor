...
<ArticleFigure image={HogansHeroes} alt="An AI generated image of wrestler Hulk Hogan making a giant submarine sandwich" align="right">
...
<ArticleFigure image={PinupPose} alt="A woman laying on her stomach, wearing a polka-dot dress, smiling. There is a Coca-cola branded cooler and a Coke bottle nearby.">
...
<ArticleFigure image={Nun} alt="Four thumbnail renders of a nun laying on the beach. The first looks reasonable, the other three have deformed hands, strange shoulders, or awkward poses.">
...
<ArticleFigure image={Celtic} alt="A woman with messy, braided red hair and green eyes, wearing a tunic decorated with celtic knots, looking to the right with a grim expression on her face.">
...
<ArticleFigure image={Screenshot} alt="A screenshot of the comfy UI, showing multiple models being loaded, and several image previews">
